...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("5. Consultar el país con mas medallistas");
	...
	/**
	 * Le muestra al usuario el país de un atleta
	 */
	private void ejecutarPaisAtleta()
	{
		...
		System.out.println("El atleta " + nombre + " es de " + nombrePais + ".");
